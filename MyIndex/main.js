...
function downloadJSAtOnload() {
    ...
    element.src = "https://cdn.jsdelivr.net/gh/sakurasep/main-cdn@main/MyIndex/music.js";
...
if (isFirefox = navigator.userAgent.indexOf("Firefox") > 0) {
    ...
    link.href = 'https://cdn.jsdelivr.net/gh/sakurasep/main-cdn@main/MyIndex/firefox.css';
    link.rel = 'stylesheet';
    link.type = 'text/css';
...
fetch('https://www.yiketianqi.com/free/day?appid=52788186&appsecret=LHnwNw6W&unescape=1')
    .then(response => response.json())
    .then(data => {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("New Dream New Start！");
        $("#change1").html("回到最初的起点");
    }
});
